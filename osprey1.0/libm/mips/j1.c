 ...
 * $Author: morrone $
 * $Source: /cvsroot/open64/open64/osprey1.0/libm/mips/j1.c,v $
 *
 * Revision history:
...
/* $Header: /cvsroot/open64/open64/osprey1.0/libm/mips/j1.c,v 1.1.1.1 2001/09/10 17:50:21 morrone Exp $ */
