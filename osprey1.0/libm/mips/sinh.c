 ...
 * $Author: morrone $
 * $Source: /cvsroot/open64/open64/osprey1.0/libm/mips/sinh.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /cvsroot/open64/open64/osprey1.0/libm/mips/sinh.c,v $ $Revision: 1.1.1.1 $";
