 ...
 * Module: cwh_addr.h
 * $Revision: 1.36 $
 * $Date: 2001/03/10 03:43:15 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_addr.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_addr.h,v $ $Revision: 1.36 $";
#endif /* _KEEP_RCS_ID */
