 ...
 * Module: cwh_types.h
 * $Revision: 1.63 $
 * $Date: 2001/03/10 03:47:22 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_types.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_types.h,v $ $Revision: 1.63 $";
#endif /* _KEEP_RCS_ID */
