 ...
 * $Revision: 1.35 $
 * $Date: 2001/03/10 03:44:16 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_defines.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/crayf90/sgi/RCS/cwh_defines.h,v $ $Revision: 1.35 $";
#endif /* _KEEP_RCS_ID */
