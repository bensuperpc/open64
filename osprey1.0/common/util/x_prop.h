 ...
 *  $Author: morrone $
 *  $Source: /cvsroot/open64/open64/osprey1.0/common/util/x_prop.h,v $
 *
 *  Revision history:
...
static const char _X_RCS_ID_[] = "$Source: /cvsroot/open64/open64/osprey1.0/common/util/x_prop.h,v $ $Revision: 1.1.1.1 $";
