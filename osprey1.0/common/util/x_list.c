 ...
 *  $Author: morrone $
 *  $Source: /cvsroot/open64/open64/osprey1.0/common/util/x_list.c,v $
 *
 *  Revision comments:
 *
...
static char *rcs_id = "$Source: /cvsroot/open64/open64/osprey1.0/common/util/x_list.c,v $ $Revision: 1.1.1.1 $";
