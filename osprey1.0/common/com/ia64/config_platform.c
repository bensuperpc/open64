 ...
 * $Author: llx $
 * $Source: /u/merge/src/osprey1.0/common/com/ia64/config_platform.c,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /u/merge/src/osprey1.0/common/com/ia64/config_platform.c,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
