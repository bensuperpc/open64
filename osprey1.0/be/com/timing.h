 ...
 * Module: timing.h
 * $Revision: 1.4 $
 * $Date: 2002/04/30 06:54:50 $
 * $Author: llx $
 * $Source: /u/merge/src/osprey1.0/be/com/timing.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *timing_rcs_id = "$Source: /u/merge/src/osprey1.0/be/com/timing.h,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
